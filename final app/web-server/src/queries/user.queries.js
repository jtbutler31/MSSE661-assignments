...
exports.GET_ME_BY_USER_ID = `SELECT user_id, username FROM users WHERE user_id = ?`; // don't return the password

exports.GET_ME_BY_USERNAME = `SELECT user_id, username FROM users WHERE username = ?`; // don't return the password
